...
CREATE TABLE aparcaments (
    ...
    tipus ENUM('carrer', 'cobert', 'aire_lliure', 'subterrani', 'parking_public', 'parking_privat') NOT NULL,
    ...
    FOREIGN KEY (operador_id) REFERENCES usuaris(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE reserves (
    ...
    estat ENUM('pendent', 'confirmada', 'en_curs', 'finalitzada', 'cancel·lada') DEFAULT 'pendent',
...
CREATE TABLE pagaments (
    ...
    metode ENUM('targeta_credit', 'targeta_debit', 'paypal', 'apple_pay', 'google_pay') NOT NULL,
    estat ENUM('pendent', 'processat', 'completat', 'fallit', 'reemborsat') DEFAULT 'pendent',
...
CREATE TABLE valoracions (
    ...
    usuari_id INT UNSIGNED NOT NULL,
    aparcament_id INT UNSIGNED NOT NULL,
    puntuacio TINYINT UNSIGNED NOT NULL CHECK (puntuacio BETWEEN 1 AND 5),
    comentari TEXT,
...
CREATE TABLE contribucions (
    ...
    usuari_id INT UNSIGNED NOT NULL,
    aparcament_id INT UNSIGNED NOT NULL,
    tipus ENUM('disponibilitat', 'foto', 'informacio', 'correccio') NOT NULL,
...
CREATE TABLE recompenses (
    ...
    nom VARCHAR(100) NOT NULL,
    descripcio TEXT,
    tipus ENUM('insignia', 'descompte', 'premium_temporal', 'punts_extra') NOT NULL,
...
CREATE TABLE articles_blog (
    ...
    categoria ENUM('mobilitat', 'sostenibilitat', 'novetats', 'consells', 'altres') NOT NULL,
...
CREATE TABLE notificacions (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    usuari_id INT UNSIGNED NOT NULL,
    tipus ENUM('info', 'alerta', 'confirmacio', 'promocio', 'sistema') NOT NULL,
    titol VARCHAR(255) NOT NULL,
...
CREATE TABLE missatges_suport (
    ...
    missatge TEXT NOT NULL,
    categoria ENUM('general', 'tecnic', 'pagament', 'compte', 'altres') NOT NULL,
