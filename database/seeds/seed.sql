...
(11, 4, 4, 'Bon aparcament per deixar el cotxe tot el dia. Personal correcte.', '{"neteja": 4, "seguretat": 4, "facilitat_acces": 4, "relacio_qualitat_preu": 4}', TRUE, 3),
(12, 4, 5, 'Instal·lacions noves i molt netes. Punt de càrrega va funcionar perfectament.', '{"neteja": 5, "seguretat": 5, "facilitat_acces": 4, "relacio_qualitat_preu": 4}', TRUE, 9),

(13, 5, 1, 'Mala experiència: el lector de matrícula no funcionava i ningú responia al timbre.', '{"neteja": 2, "seguretat": 2, "facilitat_acces": 1, "relacio_qualitat_preu": 1}', FALSE, 0),
...
INSERT INTO sessions (usuari_id, token, ip_address, user_agent, expires_at) VALUES
(5, 'tok_a8f3d9e2c1b4567890abcdef12345678', '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', '2026-02-24 18:30:00'),
(6, 'tok_b1234567890abcdef1234567890abcde', '10.0.0.45', 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X)', '2026-02-25 12:00:00'),
(7, 'tok_c9876543210fedcba0987654321fedcb', '172.16.0.22', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', '2026-02-24 22:15:00'),
(10, 'tok_d1122334455667788990011223344556', '192.168.0.88', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36', '2026-02-26 09:00:00');

-- 12. CODIS DE RESET CONTRASENYA (alguns usats, alguns pendents)
INSERT INTO codis_reset_contrasenya (usuari_id, code_hash, expires_at, used, used_at) VALUES
(8, SHA2('RESET2026ABC123', 256), '2026-02-23 10:00:00', FALSE, NULL),
(11, SHA2('RESET2026DEF456', 256), '2026-02-22 14:30:00', TRUE, '2026-02-22 14:25:00'),
(13, SHA2('RESET2026GHI789', 256), '2026-02-24 08:00:00', FALSE, NULL);

-- 13. SUBSCRIPCIONS PREMIUM
INSERT INTO subscripcions (usuari_id, tipus, estat, data_inici, data_final, preu, metode_pagament, auto_renovacio) VALUES
(5, 'anual', 'activa', '2025-03-01', '2026-03-01', 59.99, 'targeta', TRUE),
(6, 'mensual', 'activa', '2026-02-01', '2026-03-01', 6.99, 'paypal', TRUE),
(9, 'trimestral', 'activa', '2025-12-15', '2026-03-15', 17.99, 'targeta', FALSE),
(12, 'anual', 'activa', '2025-06-10', '2026-06-10', 59.99, 'targeta', TRUE),
(14, 'mensual', 'cancel·lada', '2026-01-05', '2026-02-05', 6.99, 'paypal', FALSE);

-- 14. HISTÒRIC DE DISPONIBILITAT
INSERT INTO historic_disponibilitat (aparcament_id, places_disponibles, timestamp, font) VALUES
-- Aparcament 1 (evolució durant el dia)
...
-- 16. RESERVES
INSERT INTO reserves (usuari_id, aparcament_id, data_entrada, data_sortida, estat, preu_total, descompte_aplicat, codi_reserva, notes) VALUES
-- Reserves finalitzades
(5, 1, '2026-02-15 10:00:00', '2026-02-15 18:00:00', 'finalitzada', 16.00, 0.00, 'RES-2026-000001', 'Reserva sense incidències'),
(6, 2, '2026-02-18 08:30:00', '2026-02-18 14:00:00', 'finalitzada', 11.00, 1.00, 'RES-2026-000002', 'Aplicat descompte premium'),
(7, 3, '2026-02-20 12:00:00', '2026-02-20 20:00:00', 'finalitzada', 18.00, 0.00, 'RES-2026-000003', NULL),

-- Reserves confirmades (futures)
(8, 1, '2026-02-25 09:00:00', '2026-02-25 19:00:00', 'confirmada', 20.00, 0.00, 'RES-2026-000004', 'Reserva per jornada de treball'),
(9, 4, '2026-02-26 15:00:00', '2026-02-26 22:00:00', 'confirmada', 14.00, 2.00, 'RES-2026-000005', 'Aplicat codi promocional WELCOME10'),
(10, 5, '2026-02-27 07:00:00', '2026-02-27 10:00:00', 'confirmada', 6.00, 0.00, 'RES-2026-000006', NULL),

-- Reserves en curs
(11, 2, '2026-02-23 06:00:00', '2026-02-23 23:59:00', 'en_curs', 35.00, 0.00, 'RES-2026-000007', 'Reserva de dia sencer'),
...
-- 17. PAGAMENTS
INSERT INTO pagaments (reserva_id, usuari_id, import, metode, estat, referencia_externa, data_pagament) VALUES
-- Pagaments completats (reserves finalitzades)
(1, 5, 16.00, 'targeta_credit', 'completat', 'PAY-EXT-20260215-A1B2C3', '2026-02-15 09:55:00'),
...
-- 18. FACTURES
INSERT INTO factures (pagament_id, usuari_id, numero_factura, import_subtotal, iva, import_total, data_emissio, pdf_url) VALUES
(1, 5, 'FACT-2026-000001', 13.22, 2.78, 16.00, '2026-02-15', '/factures/2026/02/FACT-2026-000001.pdf'),
...
INSERT INTO recompenses (nom, descripcio, tipus, requisit_punts, valor, icona_url, activa) VALUES
('Explorador Urbà', 'Primer aparcament reservat amb èxit', 'insignia', 0, '{"badge_level": "bronze"}', '/icons/badges/explorador_urba.svg', TRUE),
('Conductor Freqüent', 'Més de 10 reserves completades', 'insignia', 100, '{"badge_level": "plata"}', '/icons/badges/conductor_frequent.svg', TRUE),
('Expert en Mobilitat', 'Més de 50 reserves i 5 contribucions validades', 'insignia', 500, '{"badge_level": "or"}', '/icons/badges/expert_mobilitat.svg', TRUE),
('Col·laborador Actiu', 'Més de 10 contribucions validades', 'insignia', 200, '{"badge_level": "especial"}', '/icons/badges/colaborador_actiu.svg', TRUE),
...
INSERT INTO usuaris_recompenses (usuari_id, recompensa_id, data_obtencio, utilitzada, data_utilitzacio) VALUES
(5, 1, '2025-03-02 10:15:00', FALSE, NULL),
...
INSERT INTO articles_blog (titol, slug, contingut, resum, autor_id, categoria, imatge_destacada, publicat, data_publicacio, visites) VALUES
(
...
('stripe_public_key', 'pk_test_XXXXXXXXXXXXXXXX', 'string', 'Clau pública de Stripe per pagaments'),
(
    'featured_parkings',
    '[1, 3, 5]',
    'json',
...
-- 27. LOGS DEL SISTEMA
INSERT INTO logs_sistema (nivell, missatge, context, usuari_id, ip_address) VALUES
(
    'info',
    'Usuari ha iniciat sessió correctament',
    '{"user_agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)", "session_token": "tok_a8f3d9..."}',
    5,
    '192.168.1.100'
),
(
    'info',
    'Nova reserva creada',
    '{"reserva_id": 4, "aparcament_id": 1, "preu": 20.00}',
    8,
    '10.0.0.45'
),
(
    'warning',
    'Intent de pagament fallit - targeta rebutjada',
    '{"reserva_id": 11, "error_code": "card_declined", "payment_method": "targeta_credit"}',
    15,
    '172.16.0.88'
),
(
    'error',
    'Error al processar càrrega de fitxer - mida excedida',
    '{"file_size_mb": 8.5, "max_allowed_mb": 5, "user_id": 7}',
    7,
    '192.168.0.123'
),
(
...
(
    'critical',
    'Fallada de connexió amb el servidor de pagaments',
    '{"service": "stripe", "error": "connection_timeout", "retry_attempt": 3}',
    NULL,
    '10.0.0.1'
),
(
    'info',
    'Trigger de valoració executat correctament',
    '{"aparcament_id": 1, "nova_valoracio_mitjana": 4.50, "total_valoracions": 2}',
    6,
    '192.168.1.101'
),
(
    'warning',
    'Usuari ha intentat accedir a recurs no autoritzat',
    '{"endpoint": "/admin/configuracio", "user_role": "basic"}',
    10,
    '172.16.0.45'
),
(
    'info',
    'Contribució validada automàticament',
    '{"contribucio_id": 5, "tipus": "correccio", "punts_atorgats": 20}',
    9,
    '192.168.0.77'
),
(
    ...
    '{"factura_id": 9, "error": "template_not_found"}',
    NULL,
    '10.0.0.1'
),
(
    'info',
    'Nova inscripció de subscripció Premium',
    '{"usuari_id": 6, "tipus": "mensual", "preu": 6.99}',
    6,
    '192.168.1.102'
),
(
    'debug',
    'Execució de tasca programada: actualització de disponibilitat',
    '{"aparcaments_actualitzats": 5, "durada_ms": 1230}',
    NULL,
    '10.0.0.1'
);