...
VALUES (1, 3, 'https://cdn.parklive.cat/img/parking_1_entrada.jpg', 'Entrada principal', TRUE, 1),
    ...
    (5, 13, 'https://images.unsplash.com/photo-1590674867551-11c3a2df5dc4?auto=format&fit=crop&q=80&w=1200&h=600', 'Panoràmica de la zona de parking', FALSE, 1),
    (6, 1, 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=1200&h=600', 'Entrada Port Olímpic', TRUE, 1),
    (6, 2, 'https://images.unsplash.com/photo-1573348722427-f1d6819fdf98?auto=format&fit=crop&q=80&w=1200&h=600', 'Vistes des de l''aparcament', TRUE, 2);
