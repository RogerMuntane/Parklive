...
VALUES (5, 'ocupat', '{"places_lliures_aproximades": 45, "comentari": "Planta -2 gairebé plena"}', TRUE, 10, 41.3851, 2.1734),
    (6, 'ocupat', '{"url": "/uploads/contribucions/user6_parking2.jpg", "descripcio": "Foto actualitzada de l''entrada"}', TRUE, 15, 41.3879, 2.1699),
    (7, 'ocupat', '{"camp": "horari_tancament", "valor_nou": "23:00", "comentari": "Tanquen a les 23h, no 24h"}', FALSE, 0, 41.3917, 2.1649),
    (8, 'lliure', '{"places_lliures_aproximades": 30}', TRUE, 10, 41.3888, 2.1590),
    (9, 'ocupat', '{"camp": "altura_maxima", "valor_actual": "2.00", "valor_correcte": "2.10", "comentari": "He mesurat l''altura amb el meu vehicle"}', TRUE, 20, 41.3797, 2.1769),
    (10, 'ocupat', '{"comentari": "Completament ple a les 14h"}', TRUE, 10, 41.3851, 2.1734),
    (11, 'ocupat', '{"url": "/uploads/contribucions/user11_parking3_seguretat.jpg", "descripcio": "Nova càmera de seguretat instal·lada"}', TRUE, 15, 41.3917, 2.1649);
